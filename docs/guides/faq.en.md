...
See [Issue #202](https://github.com/woodyyan/nofx/issues/202) and [Troubleshooting Guide](TROUBLESHOOTING.md#-only-opening-short-positions-issue-202).
...
2. Search [existing issues](https://github.com/woodyyan/nofx/issues)
...
Open a [Feature Request](https://github.com/woodyyan/nofx/issues/new/choose) with your idea!
