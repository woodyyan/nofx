...
# https://github.com/woodyyan/nofx
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/woodyyan/nofx/dev/install.sh | bash
#
# Or with custom directory:
#   curl -fsSL https://raw.githubusercontent.com/woodyyan/nofx/dev/install.sh | bash -s -- /opt/nofx
#
...
GITHUB_RAW="https://raw.githubusercontent.com/woodyyan/nofx/dev"
...
print_success() {
    ...
    echo -e "╚════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo -e "  ${GREEN}curl -fsSL https://raw.githubusercontent.com/woodyyan/nofx/dev/install.sh | bash${NC}"
    echo ""
